...
class CreateIndex:
    ...
    def getStopwords(self):
        ...
        stopwords=[line.rstrip() for line in f]   #rstrip removes all the characters(here whitespaces) from end of the string
        self.sw=dict.fromkeys(stopwords)   #formkeys creates new dictionary with key values taken from stopwords
        f.close()
    ...
    def getTerms(self, line):
        ...
        line=line.split() #split() returns a list of all the words in the string, using str as the separator (splits on all whitespace if left unspecified)
    ...
    def createIndex(self):
        ...
        while pagedict != {}:                    
            ...
            termdictPage={}
            for position, term in enumerate(terms):	#enumerate creates a tuple with counter,element
                try:
            ...
            for termpage, postingpage in termdictPage.iteritems():   #iteritems returns a key,value pair
